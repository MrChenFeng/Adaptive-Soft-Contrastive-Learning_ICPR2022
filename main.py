...
# wandb logger
parser.add_argument('--run_id', default='ascl_project', type=str, help='project name')
parser.add_argument('--entity', default='ascl_run', type=str, help='run name')

def selfsup_train(args, model, train_loader, memory_loader, test_loader):
    wandb.init(project=args.run_id, entity=args.entity, name='train_' + args.results_dir)
    ...
    for epoch in range(epoch_start, args.epochs):
        ...
        wandb.log({'train_loss': train_loss, 'test_acc': cur_acc, 'lr': optimizer.param_groups[0]['lr']}, step=epoch)
        # save statistics
        train_logs.write(
...
def linear_eval(args, encoder, train_loader, test_loader):
    ...
    wandb.init(project=args.run_id, entity=args.entity, name='eval_' + args.results_dir)
    best_acc = 0
    best_acc5 = 0
    ...
    for epoch in range(args.eval_epochs):
        ...
        wandb.log({'Acc@1': top1_acc, 'Acc@5': top5_acc, 'Best_Acc@1': best_acc, 'Best_Acc@5': best_acc5}, step=epoch)
        print(
